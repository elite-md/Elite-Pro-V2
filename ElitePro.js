...
newsletterJid: "120363287352245413@newsletter",},
                        externalAdReply: {
                            ...
                            title: botname,
                            body: 'Welcome to the world of Ai intelligence',
                            previewType: "PHOTO",
...
// Check if the key exists before using the 'in' operator
...
//All new commands stop here that all for now
            break
            case 'addtitle':{
               if (!XeonTheCreator) return XeonStickOwner()
...
let link = 'https://chat.whatsapp.com/' + await EliteProEmpire.groupInviteCode(group)
      await EliteProEmpire.sendMessage(text+'@s.whatsapp.net', {text: `🟢 *GROUP INVITATION*\n\nA user invites you to join this group \n\n${link}\n> *ᴘᴏᴡᴇʀᴇᴅ ʙʏ ᴇʟɪᴛᴇᴘʀᴏ*`, mentions: [m.sender]})
        reply(`An invitation link was sent to the user`) 
}
break
            case 'closetime':
                if (!m.isGroup) return XeonStickGroup()
...
EliteProEmpire.sendMessage(m.chat, {
  ...
  contextInfo: {
    externalAdReply: {
      ...
      sourceUrl: groupLink, // Clickable link
...
*єхplσríng thє frσntíєrs σf αrtífícíαl íntєllígєncє, tσgєthєr*${readmore}
*╭════════════════════⊷❍*
*╭────❍* Owner Menu *❍*
*┊❍* ${prefix}autoread
*┊❍* ${prefix}getpp
...
EliteProEmpire.copyNForward(m.chat, msgs[budy.toLowerCase()], true, {quoted: m})
        ...
        let e = String(err)
EliteProEmpire.sendMessage(ownernumber + '@s.whatsapp.net', { text: "Hello developer, there seems to be an error, please fix it " + util.format(e), 
contextInfo:{
forwardingScore: 9999999, 
isForwarded: true
}})                
